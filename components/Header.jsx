                    ...
                    <div className='header-right'>
                        ...
                        <div className='wa-both'>
                            <div className='header-wa'>
                                ...
                                <a href="https://api.whatsapp.com/send/?phone=79636623890&text&app_absent=0&amp;text&amp;app_absent=0" target="_blank"><span  className='fw-600'>Связаться в WhatsApp</span></a>
                                </div>
                            </div>
                            <div>
