export const dataForm = [
    {
        id: 1,
        h2: <div className="h2">
                Получите презентацию <br />+ комплект материалов
            </div>,
        h3: <div className="h3">
                Оставьте свои данные ниже и мы отправим вам материалы
    ...
    },
    {
        id: 3,
        h2: <div className="h2">
                Скачайте презентацию<br /> + фин. модель
            </div>,
        h3: <div className="h3">
    ...
    },
    {
        id: 4,
        h2: <div className="h2">
                Проверьте свободен<br /> ли ваш город
            </div>,
        h3: <div className="h3">
    ...
    },
    {
        id: 5,
        h2: <div className="h2">
                Записаться на встречу<br /> или звонок в Zoom
            </div>,
        h3: <div className="h3">
